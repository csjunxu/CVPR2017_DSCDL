...
par.cls_num = 31;
for lambda = [0.01 0.1 0.005]
    param.lambda = lambda;
    for lambda2 = [0.01 0.05 0.1]
        param.lambda2 = lambda2;
        for sqrtmu = [0.1 0.01 0.2]
            par.sqrtmu = sqrtmu;
            for nInnerLoop = 4
                ...
                for i = 1:im_num
                    ...
                    %% output
                    imwrite(IMout, ['DSCDL_' IMname '_' num2str(lambda) '_' num2str(lambda2) '_' num2str(sqrtmu) '.png']);
